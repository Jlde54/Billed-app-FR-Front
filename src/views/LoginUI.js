            ...
            <div class="card">
              <div class="card-body">
                <form class="form-signin" data-testid="form-employee">
                  ...
                  <label for="inputEmailUser">Votre email</label>
                  <input id="inputEmailUser" type="email" data-testid="employee-email-input" class="form-control" placeholder="johndoe@email.com" required autofocus>
                  <label for="inputPasswordUser">Mot de passe</label>
                  <input id="inputPasswordUser" type="password" data-testid="employee-password-input" class="form-control" placeholder="******" required>
